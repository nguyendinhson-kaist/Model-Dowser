...
def main() -> None:
    ...
    data_path = DATASETS["coco_test"]["data_path"]
    image_dir = DATASETS["coco_test"]["media_dir"]
    ...
    for instance in tqdm(instances, disable=not dist.is_main()):
        ...
        outputs.append({"question_id": instance["id"], "prompt": question, "text": response, "reference": instance["reference"]})
